...
dist_marker_coil = -600
dist_camera_coil = -600
...
#        cv2.drawFrameAxes(frame, camera_matrix, camera_distortionZ, rvecZ, tvecZ, 1)
    ...
    pos_coil_car[0], pos_coil_car[1] = dist_x2, dist_y2                         # CAR coil position
    pos_coil_cnc[0], pos_coil_cnc[1] = 0, dist_camera_coil                      # CNC coil position
    pos_coil_com[0], pos_coil_com[1] = dist_x3, dist_y3+dist_camera_coil        #
#    pos_coil_com[0], pos_coil_com[1] = 0+dist_x3, dist_camera_coil+dist_y3

    draw_line(tvec, pos_coil_car, (255,255,255), canvas)                        # ARUCO - CAR coil
    draw_line(pos_coil_car, pos_coil_cnc, (255,255,255), canvas)                # CAR coil - CNC coil
    draw_angled_rec(pos_coil_cnc, 1000, 1000, 0, (255,255,255), canvas)         # CNC frame
    draw_angled_rec(pos_coil_car, 200, 200, -yaw_marker, (255,255,255), canvas) # CAR coil
    draw_angled_rec(pos_coil_cnc, 400, 400, 0, (0,255,255), canvas)             # CNC coil
    draw_angled_rec(pos_coil_com, 400, 400, 0, color_success, canvas)           # CNC coil COMMANDED

#    sys.stderr.write("Data4: \n{}\n".format(b))
    #--- Display the frame
#    cv2.imshow('frame', canvas)
    cv2.imwrite('resultImage.jpg', canvas)
